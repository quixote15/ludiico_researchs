...
\begin{quadro}[h]
\caption{Palavras-chave e Termos}
\centering
...
\begin{tabular}{m{ 7cm}}
 \centering
  \textbf {Termos (Inglês)} \end{tabular} \\
 \hline
\centering
Gerência de projeto  & \begin{tabular}{m{ 7cm}}
 \centering
Project Management\end{tabular}\\
\hline

\centering Metodologia ágil  & 
\begin{tabular}{m{ 7cm}}
 \centering
Agile methodology, Agile methodologie ou Agile Methodologies \end{tabular} \\
\hline
\centering Desenvolvimento ágil  &  \begin{tabular}{m{ 7cm}}
 \centering
Agile development \end{tabular}\\
\hline
\end{tabular}
\legend{Fonte: Autores (2017)}

  \label{quadropalavrachave}
\end{quadro}
